...
class LogWindow(wx.Frame):
    ...
    def init_ui(self):
        ...
        self.password = wx.TextCtrl(panel, -1, personal.password,
        ...
        for (t, b) in [(username_text, self.username),
...
class Window(wx.Frame):
    ...
    def __init__(self, parent,  title, pivots):
        super(Window, self).__init__(parent, title=title, size=WIN_SIZE)
    ...
    def init_ui(self):
        ...
        widgets = [self.buy_button, self.sell_button, self.nb_pos, self.balance,
                   self.pnl]
        widgets += self.pivots
        ...
        self.columns = [u'guaranteedStop', u'status', u'direction',
                        u'limitLevel', u'level', u'affectedDeals',
                        u'limitDistance', u'dealReference', u'dealStatus',
                        u'dealId', u'reason', u'stopLevel', u'epic',
                        u'stopDistance', u'expiry', u'size']
