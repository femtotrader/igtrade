...
class LogWindow(wx.Frame):
    ...
    def InitUI(self):
        ...
        sizer.Add(self.tcUsername, pos=(2, 1), span=(1, 2),
                  flag=wx.TOP | wx.EXPAND)

        # Label Password
        textPasswd = wx.StaticText(panel, label="Password")
        sizer.Add(textPasswd, pos=(3, 0),
                  flag=wx.LEFT | wx.TOP, border=5)
        # Textcontrol Password
        self.tcPasswd = wx.TextCtrl(panel, -1,
                                    personal.password.decode('base64'),
                                    style=wx.TE_PASSWORD)
        sizer.Add(self.tcPasswd, pos=(3, 1), span=(1, 2),
        ...
        sizer.Add(self.tcApi, pos=(4, 1), span=(1, 3),
                  flag=wx.TOP | wx.EXPAND, border=5)
        ...
        sizer.Add(self.tcNbAccount, pos=(6, 1), span=(1, 1),
                  flag=wx.TOP | wx.EXPAND, border=5)
        ...
        sizer.Add(self.tcProxy, pos=(7, 1), span=(1, 3),
                  flag=wx.TOP | wx.EXPAND, border=5)
        ...
        if personal.epic != '':
            ...
            MonEpic = globalvar.epic_dict.keys()[index_epic]
        else:
        ...
        self.chkCGU = wx.CheckBox(panel, label=disclaimer)
